...
public class TwitterLogin extends Activity {
	final static String TWITTER_CONSUMER_KEY = "U2EZrKPpUtUMU5875XzwIFzJh";
	final static String TWITTER_CONSUMER_SECRET = "eEFp2hxOa83DMplBhNV0LqQ15WDQY7Ca8RvHqKtln9KaG8VUx4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userName = (EditText) findViewById(R.id.user_info);
			...
			public void onClick(View arg0) {
				...
				if(userName.getText().toString().trim().length()<=0){
					Toast.makeText(getApplicationContext(), "Please enter User name! ", Toast.LENGTH_SHORT).show();
	               	...
	               	Intent intent = new Intent(getBaseContext(), TwitterResult.class);
